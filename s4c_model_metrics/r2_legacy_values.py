...
spark = SparkSession.builder.appName("PySpark Read Parquet of r2 legacy values").getOrCreate()
work_dir = r"/Users/joseph.mcmilllan/Documents/projects/s4c/slide_deck/r2_legacy_values"
